...
function createFloor() {
  ...
  let blockPlane = new THREE.Mesh(new THREE.BufferGeometry(),
...
function createBox() {
  ...
  let box = new THREE.Mesh(new THREE.BufferGeometry(), 
...
function createSphere() {
  ...
  let sphere = new THREE.Mesh(new THREE.BufferGeometry(radius, 32, 32), 
...
function createCylinder() {
  ...
  // threejs
  let cylinder = new THREE.Mesh(new THREE.BufferGeometry(radius, radius, height, 32), new THREE.MeshPhongMaterial({ color: 0x90ee90 }))
